...
const dict = {
  ...
  home: {
    en: {
      ...
      dt_api: 'API', dt_docs: 'Docs', dt_config: 'Config', dt_binary: 'Binary', dt_cdp_port: 'CDP Port',
      binary_not_set: 'Not installed. Install from', cdp_not_set: 'Not configured. Set CDP port in Settings.',
    ...
    zh: {
      ...
      dt_api: 'API', dt_docs: '文档', dt_config: '配置', dt_binary: '可执行文件', dt_cdp_port: 'CDP 端口',
      binary_not_set: '未安装，从以下地址安装', cdp_not_set: '未配置，请在设置页填入 CDP 端口。',
